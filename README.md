...
`В первом` модуле представленны простые фигуры.\
`Во втором` модуле представленны фракталы.\
`В третьем` модуле представленны сложные фигуры.\
`В четвертом` модуле представленно наложение фигур.
...
Проект представляет собой приложение игры в угадываение чисел.
